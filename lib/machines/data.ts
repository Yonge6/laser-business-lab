...
export const machines: Machine[] = [
  {
    ...
    strengthsZh: ["为杯子生产优化的工作流", "集成旋转设置", "可重复的精准定位"],
    productionLevel: 4,
    budgetTier: 3,
  ...
  },
  {
    ...
    strengthsZh: ["精细 RF 雕刻", "紧凑一体化设计", "广泛的材料适配能力"],
    productionLevel: 3,
    budgetTier: 3,
  ...
  },
  {
    ...
    strengthsZh: ["工作室级切割能力", "大工作幅面", "适合成长中的工作室"],
    productionLevel: 4,
    budgetTier: 3,
  ...
  },
  {
    ...
    strengthsZh: ["面向生产的平台", "高吞吐量工作流", "工业级工作幅面"],
    productionLevel: 5,
    budgetTier: 4,
