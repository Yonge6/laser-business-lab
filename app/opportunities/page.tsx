...
export const metadata: Metadata = { alternates: { canonical: "/opportunities/" }, title: "Maker Product Opportunity Finder", description: "Find and rank laser and 3D printing product opportunities by demand, margin, competition, time, and equipment fit." };
