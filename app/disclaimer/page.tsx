...
export const metadata: Metadata = { alternates: { canonical: "/disclaimer/" }, title: "Disclaimer", description: "Important limitations for Maker Business Lab estimates and recommendations." };
