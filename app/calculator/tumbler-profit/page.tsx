...
export const metadata: Metadata = { alternates: { canonical: "/calculator/tumbler-profit/" }, title: "Tumbler Profit Calculator", description: "Estimate tumbler revenue, gross profit, production hours, and theoretical shift capacity." };
