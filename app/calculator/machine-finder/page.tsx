...
export const metadata: Metadata = { alternates: { canonical: "/calculator/machine-finder/" }, title: "Maker Equipment Finder", description: "Get a transparent laser, 3D-printing, or heat-press equipment-category match based on what you make, volume, priorities, investment level, and experience." };
