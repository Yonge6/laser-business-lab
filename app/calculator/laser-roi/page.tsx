...
export const metadata: Metadata = { title: "Maker Product ROI Calculator", description: "Estimate maker product margin, monthly gross profit, production hours, and equipment payback for laser, 3D-printing, or heat-press products." };
