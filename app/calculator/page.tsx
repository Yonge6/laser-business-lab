...
export const metadata: Metadata = { alternates: { canonical: "/calculator/" }, title: "Free Maker Business Calculators", description: "Free profit, ROI, tumbler, and machine fit tools for maker businesses." };
