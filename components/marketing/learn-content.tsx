...
const pillars = [
  { title: "Make money", titleZh: "开始赚钱", items: ["How much can a maker business make?", "How should you price laser and 3D-printed products?", "What maker product should you sell first?"], itemsZh: ["Maker 生意能赚多少钱？", "激光与 3D 打印产品应该如何定价？", "第一款 Maker 产品应该卖什么？"] },
