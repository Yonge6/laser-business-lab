...
const pillars = [
  { title: "Make money", titleZh: "开始赚钱", items: ["How much can a maker business make?", "How should you price laser, 3D-printed, and heat-pressed products?", "What maker product should you sell first?"], itemsZh: ["Maker 生意能赚多少钱？", "激光、3D 打印与热压产品应该如何定价？", "第一款 Maker 产品应该卖什么？"] },
  { title: "Choose a making path", titleZh: "选择制作路径", items: ["Laser vs 3D printing vs heat press", "RF vs glass-tube CO₂", "Best setup for personalized textiles"], itemsZh: ["激光、3D 打印与热压转印如何选择？", "RF 与玻璃管 CO₂ 如何选择？", "个性化布艺适合什么设备方案？"] },
