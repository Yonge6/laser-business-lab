...
const tools = [
  { icon: Calculator, title: "Product ROI Calculator", titleZh: "产品 ROI 计算器", description: "Calculate margin, capacity, and equipment payback for laser or 3D-printing products.", descriptionZh: "分别计算激光或 3D 打印产品的毛利、产能和设备回本周期。", href: "/calculator/laser-roi", marker: "01" },
  ...
  { icon: Crosshair, title: "Maker Equipment Finder", titleZh: "Maker 设备匹配器", description: "Choose laser or 3D printing, then get a transparent equipment-category match.", descriptionZh: "先选择激光或 3D 打印，再获得透明的设备类别匹配。", href: "/calculator/machine-finder", marker: "03" },
];
