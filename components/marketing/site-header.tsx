    ...
    <header className="site-header">
      <div className="shell header-inner">
        <Link className="brand" href="/" aria-label={locale === "zh" ? "Maker Business Lab 首页" : "Maker Business Lab home"}>
          <span className="brand-mark-source" aria-hidden="true"><Image src={assetPath("/images/maker-brand-mark.png")} alt="" width={192} height={192} preload /></span>
