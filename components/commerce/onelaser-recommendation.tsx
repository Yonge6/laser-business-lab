  ...
  return (
    <aside className={compact ? "onelaser-recommendation compact" : "onelaser-recommendation"} aria-label={zh ? "OneLaser 官方设备建议" : "Official OneLaser equipment suggestion"}>
      ...
      <div className="onelaser-recommendation-actions">
        <a className="button button-primary" href={productUrl} target="_blank" rel="noreferrer" onClick={() => track("product")}>{compact ? (zh ? "浏览 1Laser 激光设备" : "Browse 1Laser machines") : (zh ? "在 1Laser 查看匹配设备" : "View matched machine on 1Laser")}<ArrowSquareOut weight="bold" /></a>
